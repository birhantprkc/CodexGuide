...
| <a href="https://ergouapi.com/r/gh-codexguide"><img src="./assets/sponsors/ergou-api.jpg" alt="Ergou API" width="240"></a> | Thanks to Ergou API for sponsoring this project. [Ergou API](https://ergouapi.com/r/gh-codexguide) is an AI model API relay platform offering 0.1x–0.2x rates across the site and access to original Claude, GPT, Grok, and other international and Chinese models. IPLC connectivity and redundant residential dual-ISP routing are designed to provide stable, low-latency access across China. Developers and studios can [register here](https://ergouapi.com/r/gh-codexguide) to learn more. |
